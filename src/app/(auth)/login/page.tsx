...
import { setIsLoggedIn, setLogin, setToken } from '@/lib/userSlice'
...
export default function LoginPage() {
	...
	return (
		<section className='mt-10 mx-auto p-10 max-w-2xl rounded-2xl  bg-emerald-800 text-white'>
			<form action={dispatch}>
				<Fieldset className='space-y-8'>
					<Legend className='py-1 text-lg font-bold text-center bg-white/10 rounded-lg select-none'>
						Log in
					</Legend>
